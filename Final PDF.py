...
EXCELFILEOPENOPTIONS = dict(defaultextension=".xlsx",filetypes5=[('excel file', '*.xlsx')])
...
def excel_path1():
    global excel_path
    excel_path=filedialog.askopenfilename(**EXCELFILEOPENOPTIONS)
...
def convertfile():
    ...
    exit_button=Button(root3,text="Exit",bg="yellow", fg="blue",font=("Arial Bold", 15),command=root3.destroy)
    exit_button.grid(row = 2, column = 2)
    root3.mainloop()
    root4=Tk()
